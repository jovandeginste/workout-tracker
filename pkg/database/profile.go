...
type Profile struct {
	...
	TotalsShow          WorkoutType `form:"totals_show" json:"totalsShow"`                    // What workout type of totals to show
	Timezone            string      `form:"timezone" json:"timezone"`                         // The user's preferred timezone
	AutoImportDirectory string      `form:"auto_import_directory" json:"autoImportDirectory"` // The user's preferred directory for auto-import
	UserID              uint64      `json:"userID"`                                           // The ID of the user who owns this profile
	APIActive           bool        `form:"api_active" json:"apiActive"`                      // Whether the user's API key is active
	SocialsDisabled     bool        `form:"socials_disabled" json:"socialsDisabled"`          // Whether social sharing buttons are disabled when viewing a workout
	PreferFullDate      bool        `form:"prefer_full_date" json:"preferFullDate"`           // Whether to show full dates in the workout details
}
