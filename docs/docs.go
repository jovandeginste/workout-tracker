...
const docTemplate = `{
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "result": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/app.WorkoutSimilarity"
                                            }
                                        }
                                    }
                                }
    ...
    "definitions": {
        ...
        "app.WorkoutSimilarity": {
            "type": "object",
            "properties": {
                "similarity": {
                    "description": "The similarity score, as a fraction between 0 and 1, where 1 is identical",
                    "type": "number"
                },
                "workout_id": {
                    "description": "The ID of the other workout",
                    "type": "integer"
                }
            }
        },
