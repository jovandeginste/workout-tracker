...
func WorkoutMap(w *database.Workout) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `views/partials/workout_map.templ`, Line: 14, Col: 59}
		}
		...
		for _, p := range w.Details().Points {
			points = append(points, point{
				...
				Title:     WorkoutPointTitle(ctx, pu, &p),
			})
		}
		...
		if !helpers.AppConfig(ctx).SocialsDisabled && !helpers.CurrentUser(ctx).Profile.SocialsDisabled {
			templ_7745c5c3_Err = WorkoutSocial(w).Render(ctx, templ_7745c5c3_Buffer)
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
		}
